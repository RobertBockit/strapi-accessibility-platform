...
export interface ApiAccessibilityFeatureAccessibilityFeature
  ...
  attributes: {
    ...
    event: Schema.Attribute.Relation<'manyToOne', 'api::name.name'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCompanionPersonCompanionPerson
  extends Struct.CollectionTypeSchema {
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contact_data: Schema.Attribute.Component<
    ...
    events: Schema.Attribute.Relation<'manyToMany', 'api::name.name'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::location.location'
    >;
    location_overview: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    opening_hours: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNameName extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<['opera', 'cinema', 'race']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    language: Schema.Attribute.Enumeration<['English ', 'German', 'Latvian']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    need_for_accessibilities: Schema.Attribute.Relation<
      'oneToMany',
      'api::need-for-accessibility.need-for-accessibility'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seat_map: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiNeedForAccessibilityNeedForAccessibility
  extends Struct.CollectionTypeSchema {
  collectionName: 'need_for_accessibilities';
  info: {
    displayName: 'NeedForAccessibility';
    pluralName: 'need-for-accessibilities';
    singularName: 'need-for-accessibility';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::companion-person.companion-person': ApiCompanionPersonCompanionPerson;
